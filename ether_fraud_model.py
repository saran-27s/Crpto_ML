...
class EthereumFraudDetector:
    ...
    def predict_risk(self, wallet_data, threshold=0.5):
        ...
        for feature in self.features:
            ...
            # Try to find a matching column with different spacing
            if feature not in wallet_data.columns:
                # Look for the column with different spacing
                ...
                if possible_matches:
                    ...
                    # If no match found, create the column with zeros
    ...
    def generate_report(self, wallet_data, prediction_result):
        ...
        # Try to get transaction information, handle column name variations
        def get_column_value(column_names):
            for col in column_names:
                if col in wallet_data.columns:
                    return wallet_data[col].iloc[0]
            return "N/A"  # Return N/A if none of the column variations exist
